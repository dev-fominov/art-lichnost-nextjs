        ...
        <Section>
            ...
            <div className={styles.aboutBox}>
                ...
                <div className={styles.contentBox}>
                    {data.our_mission.list_mission.map((item: any, index: any) => <div key={index}
                        ...
                        <div className={styles.itemDescriptionArr}>
                            {item}
                        </div>
                    </div>)}
                </div>
            ...
            <div className={styles.aboutBox}>
                ...
                <div className={styles.awardsBox}>
                    {data.our_awards.map((item: any, index: any) => <div key={index}
                                                                         className={styles.awardsItem}>
                        <div className={styles.itemNag1}>
                            {item.year}
                        </div>
                        <div className={styles.itemNag2}>
                            {item.award}
                        </div>
                    </div>)}
                </div>
