										...
										<div className={styles.modalFlex}>
											...
											{showInnerModal && <Modal styles={{
												...
												<div style={{ marginTop: '20px', fontSize: '14px' }}>
													<p style={{ marginBottom: '10px', fontSize: '14px' }}><b>Обращаем ваше внимание</b></p>
													<p style={{ marginBottom: '10px', fontSize: '14px' }}>1. Поданная заявка не является подтверждением бронирования места. Бронь места производится только после звонка администратора, получения подтверждения наличия места на электронную почту и осуществления предоплаты в размере 15 000 рублей.</p>
													<p style={{ fontSize: '14px' }}>2. Размещение в лагере формируется по гендерному признаку, поэтому наличие мест (зеленая кнопка) в группе может означать  в том числе свободные места либо только  для девочек, либо только для мальчиков.</p>
												</div>
