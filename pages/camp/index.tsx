            ...
            {data.background_video
                ? <div style={{position: "relative"}} className="video-background">
                    <iframe
                        ...
                        src={`https://www.youtube.com/embed/${data.background_video}?autoplay=1&controls=0&rel=0&showinfo=0&mute=1&modestbranding=1&iv_load_policy=3&playsinline=1&enablejsapi=1&origin=https%3A%2F%2Fart-lichnost.vercel.app&widgetid=1`}
                    />
                    <ContentHeader/>
                </div>
